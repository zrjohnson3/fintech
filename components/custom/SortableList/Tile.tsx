    ...
    if (id === 'spent') {
        return (
            <View style={styles.container} pointerEvents="none">
                <Text style={{ color: Colors.gray, fontWeight: '500', fontSize: 16, paddingBottom: 20 }}>
                    Spent this month
                </Text>
                <Text style={{ color: Colors.dark.background, fontWeight: 'bold', fontSize: 26, paddingTop: 10 }}>
                    $1025.25
                </Text>
            </View>
        );
                ...
                <View>
                    ...
                    {transactions.length > 0 && (
                        <>
                            ...
                            {/* <Text style={{ color: Colors.dark2, fontWeight: 'bold', fontSize: 16 }}>
                                ${transactions[transactions.length - 1].amount}
                            </Text> */}
